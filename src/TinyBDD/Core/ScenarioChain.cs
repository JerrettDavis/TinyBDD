...
public sealed class ScenarioChain<T>
{
    ...
    {
        _p.Enqueue(StepPhase.When, StepWord.Primary, "", (s, _) => new ValueTask<object?>(f((T)s!)));
        return new ScenarioChain<TOut>(_p);
    }
    ...
    {
        _p.EnqueueInherit(title, (s, _) => new ValueTask<object?>(f((T)s!)), StepWord.And);
        return new ScenarioChain<TOut>(_p);
    }
    ...
    {
        _p.EnqueueInherit(title, (s, _) => new ValueTask<object?>(f((T)s!)), StepWord.But);
        return new ScenarioChain<TOut>(_p);
    }
    ...
    {
        _p.EnqueueInherit("", (s, _) => new ValueTask<object?>(f((T)s!)), StepWord.And);
        return new ScenarioChain<TOut>(_p);
    }
    ...
    {
        _p.EnqueueInherit("", (s, _) => new ValueTask<object?>(f((T)s!)), StepWord.But);
        return new ScenarioChain<TOut>(_p);
    }
