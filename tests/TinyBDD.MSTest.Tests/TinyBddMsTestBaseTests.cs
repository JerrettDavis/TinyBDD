...
public class TinyBddMsTestBaseTests
{
    ...
    [TestMethod]
    public async Task Init_Resolves_Exact_Method()
    {
    ...
    [TestMethod]
    public async Task Init_Resolves_Prefix_Name()
    {
    ...
    [TestMethod]
    public async Task Init_Resolves_Scenario_Fallback()
    {
    ...
    [TestMethod]
    public async Task Init_When_Type_Not_Found_Sets_Null_Method()
    {
    ...
    [TestMethod]
    public async Task Cleanup_With_And_Without_Context()
    {
        var type = typeof(MsProbeTypes.Exact);
        var drv = new MsBaseDriver();
